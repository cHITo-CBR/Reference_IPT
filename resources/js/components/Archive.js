    ...
    const handleUnarchive = async (archive) => {
        try {
            if (archive.document_type === 'SchoolYear' && archive.reference_number) {
                ...
                setMessage('Unarchive is only available for School Year items.');
            }
        } catch (error) {
                            ...
                            archives.map(archive => (
                                <tr key={archive.id}>
                                    ...
                                    <td className="actions">
                                        ...
                                        {archive.status === 'Archived' && archive.document_type === 'SchoolYear' && (
                                        ...
                                        {archive.document_type === 'SchoolYear' && (
                                            <button className="btn-icon" onClick={() => navigate('/settings/school-year')} title="View Year">View</button>
                                        )}
                                    </td>
                                </tr>
                            ))
